...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "google-antigravity": [
        "gemini-3.5-flash-extra-low", "gemini-3.5-flash-low", "gemini-3-flash-agent", "gemini-3.1-pro-low",
        "gemini-pro-agent", "claude-sonnet-4-6", "claude-opus-4-6-thinking", "gpt-oss-120b-medium",
    ],
    "zai": [
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [ProviderEntry(*row) for row in (
    ...
    ("google-antigravity", "Google Antigravity (OAuth)", "Google Antigravity via agy CLI OAuth (Gemini/Claude where entitled)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "Google AI Studio, Vertex AI, and Antigravity OAuth", ["gemini", "vertex", "google-antigravity"]),
...
_PROVIDER_ALIASES = dict((
    ...
    ("alibaba-cloud", "alibaba"), ("qwen-portal", "qwen-oauth"),
    ("antigravity", "google-antigravity"), ("antigravity-oauth", "google-antigravity"),
    ("antigravity-cli", "google-antigravity"), ("google-antigravity-oauth", "google-antigravity"),
    ("agy", "google-antigravity"), ("agy-cli", "google-antigravity"), ("hf", "huggingface"),
