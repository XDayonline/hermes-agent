...
def resolve_runtime_provider(
    *,
    ...
    # Antigravity is backed by the local agy/Antigravity OAuth token. Resolve it
    # before named-custom providers and credential pools so stale manual entries
    # cannot hijack runtime routing after upstream merges.
