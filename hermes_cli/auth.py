...
# Google Antigravity OAuth (Antigravity Code Assist backend). The base URL is a sentinel the
# Antigravity client rewrites to the local Code Assist proxy.
...
OAUTH_PROVIDER_FLOWS: Dict[str, OAuthProviderFlow] = {
    ...
    "google-antigravity": OAuthProviderFlow(
        "google-antigravity", "resolve_antigravity_oauth_runtime_credentials",
